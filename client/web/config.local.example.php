...
/*
 * You should make a copy of this file and rename it to config.local.php
 * because you may wanna change these parameters:
 */

$config['database']['name'] = 'ophmisu';
$config['database']['username'] = 'ophmisu';
$config['database']['password'] = '';
// $config['app']['hostname'] = 'ophmisu.com'; // unless you're not happy with $_SERVER['HTTP_HOST']
$config['app']['path'] = '/';
